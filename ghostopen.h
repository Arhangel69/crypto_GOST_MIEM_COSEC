//
// Created by kuzmi on 05.12.2019.
//

#ifndef IMITOVSTAVKA_GHOSTOPEN_H
#define IMITOVSTAVKA_GHOSTOPEN_H
...
namespace crypto
{
    ...
    public:
        ...
        uint8_t key_full_[32] = {0xF7, 0x72, 0x31, 0x6B, 0x22, 0x5C, 0x45, 0xA1, 0x2C, 0xB5, 0xB6, 0x20, 0x7A, 0x04,
                                 0x2D,
                                 0xCA, 0xAD, 0x2A, 0x63, 0x3E, 0x26, 0x19, 0xD3, 0x73, 0x49, 0x57, 0xB0, 0x27, 0x19,
                                 0xF9,
                                 0x6B, 0x97};
        uint32_t KEYS_[8] = {0xF772316B, 0x225C45A1, 0x2CB5B620, 0x7A042DCA, 0xAD2A633E, 0x2619D373, 0x4957B027,
                             0x19F96B97};

        // S-block id-GostR3411-94-TestParamSet

        uint8_t sBlock_[8][16] = {{0x4, 0xA, 0x9, 0x2, 0xD, 0x8, 0x0, 0xE, 0x6, 0xB, 0x1, 0xC, 0x7, 0xF, 0x5, 0x3},
...
#endif //IMITOVSTAVKA_GHOSTOPEN_H
